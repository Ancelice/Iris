...
for i in range(len(filename) - 2):
    ...
    for k in range(len(tmp2)):
        ...
        test_y.append(int(tmp2[k]))
        TIME.append(editName)
        OBS.append(int(tmp2[k]))
