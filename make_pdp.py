...
saveName = './FL/pdp/Africa/' + saveName
wb.save(saveName)
...
saveName = saveName.replace('./data/', '')
saveName = saveName.replace('log_', '')
saveName = './FL/pdp/Europe/' + saveName
wb.save(saveName)
...
saveName = saveName.replace('./data/', '')
saveName = saveName.replace('log_', '')
saveName = './FL/pdp/Oceania/' + saveName
wb.save(saveName)
