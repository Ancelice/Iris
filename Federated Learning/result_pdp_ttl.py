...
filename = os.listdir("C:/Users/anli/iris/FL/result/pdp_ttl/Africa")
print("Africa")
...
for a in range(len(filename)):
    ...
    print(filename[a])
    df  = pd.read_excel("./result/pdp_ttl/Africa/" + filename[a], engine="openpyxl")
    AFTIME.append(a)
...
filename = os.listdir("C:/Users/anli/iris/FL/result/pdp_ttl/Asia")
print("Asia")
...
for d in range(len(filename)):
    ...
    print(filename[d])
    df  = pd.read_excel("./result/pdp_ttl/Asia/" + filename[d], engine="openpyxl")
    ASTIME.append(d)
...
filename = os.listdir("C:/Users/anli/iris/FL/result/pdp_ttl/Europe")
print("Europe")
...
for g in range(len(filename)):
    ...
    print(filename[g])
    df  = pd.read_excel("./result/pdp_ttl/Europe/" + filename[g], engine="openpyxl")
    EUTIME.append(g)
...
filename = os.listdir("C:/Users/anli/iris/FL/result/pdp_ttl/NA")
print("NA")
...
for j in range(len(filename)):
    ...
    print(filename[j])
    df  = pd.read_excel("./result/pdp_ttl/NA/" + filename[j], engine="openpyxl")
    NATIME.append(j)
...
filename = os.listdir("C:/Users/anli/iris/FL/result/pdp_ttl/Oceania")
print("Oceania")
...
for m in range(len(filename)):
    ...
    print(filename[m])
    df  = pd.read_excel("./result/pdp_ttl/Oceania/" + filename[m], engine="openpyxl")
    OCTIME.append(m)
...
filename = os.listdir("C:/Users/anli/iris/FL/result/pdp_ttl/SA")
print("SA")
...
for p in range(len(filename)):
    ...
    print(filename[p])
    df  = pd.read_excel("./result/pdp_ttl/SA/" + filename[p], engine="openpyxl")
    SATIME.append(p)
...
for s in range(len(filename)):
    ...
    print(filename[s])
    df  = pd.read_excel("./result/pdp_ttl/Master/" + filename[s], engine="openpyxl")
    MASTIME.append(s)
