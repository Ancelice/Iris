...
for i in range(len(filename) - 1):
    ...
    savename = './result/pdp_ttl/Africa/' +  tmpName + '.xlsx'
    ...
    tmpName = editName.replace('log_', '')
    tmpName = tmpName.replace('/', '_')
    savename = './result/pdp_ttl/Asia/' +  tmpName + '.xlsx'
    ...
    tmpName = editName.replace('log_', '')
    tmpName = tmpName.replace('/', '_')
    savename = './result/pdp_ttl/Europe/' +  tmpName + '.xlsx'
    ...
    tmpName = editName.replace('log_', '')
    tmpName = tmpName.replace('/', '_')
    savename = './result/pdp_ttl/NA/' +  tmpName + '.xlsx'
    ...
    tmpName = editName.replace('log_', '')
    tmpName = tmpName.replace('/', '_')
    savename = './result/pdp_ttl/Oceania/' +  tmpName + '.xlsx'
    ...
    tmpName = editName.replace('log_', '')
    tmpName = tmpName.replace('/', '_')
    savename = './result/pdp_ttl/SA/' +  tmpName + '.xlsx'
    ...
    tmpName = editName.replace('log_', '')
    tmpName = tmpName.replace('/', '_')
    savename = './result/pdp_ttl/Master/' +  tmpName + '.xlsx'
