...
for i in range(len(filename) - 1):
    ...
    for a in range(len(tmp1)):
        ...
        AFtrain_y.append(int(ipaddress.IPv4Address(df.iat[a, 1])))
    ...
    for b in range(len(tmp1)):
        ...
        AStrain_y.append(int(ipaddress.IPv4Address(df.iat[b, 1])))
    ...
    for c in range(len(tmp1)):
        ...
        EUtrain_y.append(int(ipaddress.IPv4Address(df.iat[c, 1])))
    ...
    for d in range(len(tmp1)):
        ...
        NAtrain_y.append(int(ipaddress.IPv4Address(df.iat[d, 1])))
    ...
    for e in range(len(tmp1)):
        ...
        OCtrain_y.append(int(ipaddress.IPv4Address(df.iat[e, 1])))
    ...
    for f in range(len(tmp1)):
        ...
        SAtrain_y.append(int(ipaddress.IPv4Address(df.iat[f, 1])))
    ...
    for aa in range(len(tmp2)):
        ...
        AFtest_y.append(int(ipaddress.IPv4Address(df2.iat[aa, 1])))
    ...
    for bb in range(len(tmp2)):
        ...
        AStest_y.append(int(ipaddress.IPv4Address(df2.iat[bb, 1])))
    ...
    for cc in range(len(tmp2)):
        ...
        EUtest_y.append(int(ipaddress.IPv4Address(df2.iat[cc, 1])))
    ...
    for dd in range(len(tmp2)):
        ...
        NAtest_y.append(int(ipaddress.IPv4Address(df2.iat[dd, 1])))
    ...
    for ee in range(len(tmp2)):
        ...
        OCtest_y.append(int(ipaddress.IPv4Address(df2.iat[ee, 1])))
    ...
    for ff in range(len(tmp2)):
        ...
        SAtest_y.append(int(ipaddress.IPv4Address(df2.iat[ff, 1])))
    ...
    for g in range(len(tmp3)):
        ...
        MAStest_y.append(int(ipaddress.IPv4Address(df3.iat[g, 1])))
    ...
    savename = './result/rsa_pdp/Africa/' +  tmpName + '.xlsx'
    ...
    tmpName = editName.replace('log_', '')
    tmpName = tmpName.replace('/', '_')
    savename = './result/rsa_pdp/Asia/' +  tmpName + '.xlsx'
    ...
    tmpName = editName.replace('log_', '')
    tmpName = tmpName.replace('/', '_')
    savename = './result/rsa_pdp/Europe/' +  tmpName + '.xlsx'
    ...
    tmpName = editName.replace('log_', '')
    tmpName = tmpName.replace('/', '_')
    savename = './result/rsa_pdp/NA/' +  tmpName + '.xlsx'
    ...
    tmpName = editName.replace('log_', '')
    tmpName = tmpName.replace('/', '_')
    savename = './result/rsa_pdp/Oceania/' +  tmpName + '.xlsx'
    ...
    tmpName = editName.replace('log_', '')
    tmpName = tmpName.replace('/', '_')
    savename = './result/rsa_pdp/SA/' +  tmpName + '.xlsx'
    ...
    tmpName = editName.replace('log_', '')
    tmpName = tmpName.replace('/', '_')
    savename = './result/rsa_pdp/Master/' +  tmpName + '.xlsx'
