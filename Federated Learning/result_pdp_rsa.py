...
filename = os.listdir("C:/Users/anli/iris/FL/result/pdp_rsa/Africa")
print("Africa")
...
for a in range(len(filename)):
    ...
    print(filename[a])
    df  = pd.read_excel("./result/pdp_rsa/Africa/" + filename[a], engine="openpyxl")
    AFTIME.append(a)
...
filename = os.listdir("C:/Users/anli/iris/FL/result/pdp_rsa/Asia")
print("Asia")
...
for d in range(len(filename)):
    ...
    print(filename[d])
    df  = pd.read_excel("./result/pdp_rsa/Asia/" + filename[d], engine="openpyxl")
    ASTIME.append(d)
...
filename = os.listdir("C:/Users/anli/iris/FL/result/pdp_rsa/Europe")
print("Europe")
...
for g in range(len(filename)):
    ...
    print(filename[g])
    df  = pd.read_excel("./result/pdp_rsa/Europe/" + filename[g], engine="openpyxl")
    EUTIME.append(g)
...
filename = os.listdir("C:/Users/anli/iris/FL/result/pdp_rsa/NA")
print("NA")
...
for j in range(len(filename)):
    ...
    print(filename[j])
    df  = pd.read_excel("./result/pdp_rsa/NA/" + filename[j], engine="openpyxl")
    NATIME.append(j)
...
filename = os.listdir("C:/Users/anli/iris/FL/result/pdp_rsa/Oceania")
print("Oceania")
...
for m in range(len(filename)):
    ...
    print(filename[m])
    df  = pd.read_excel("./result/pdp_rsa/Oceania/" + filename[m], engine="openpyxl")
    OCTIME.append(m)
...
filename = os.listdir("C:/Users/anli/iris/FL/result/pdp_rsa/SA")
print("SA")
...
for p in range(len(filename)):
    ...
    print(filename[p])
    df  = pd.read_excel("./result/pdp_rsa/SA/" + filename[p], engine="openpyxl")
    SATIME.append(p)
...
filename = os.listdir("C:/Users/anli/iris/FL/result/pdp_rsa/Master")
print("Master")
...
for s in range(len(filename)):
    ...
    print(filename[s])
    df  = pd.read_excel("./result/pdp_rsa/Master/" + filename[s], engine="openpyxl")
    MASTIME.append(s)
